...
parser.add_argument("--decoder", type=str, default="multi-decoder")  # single
...
parser.add_argument("--init_emo_emb", action="store_true") #默认为false.运行代码时手动添加参数才是True
...
parser.add_argument("--pointer_gen1", action="store_true",default=True)
...
parser.add_argument("--mean_query", action="store_true") #默认false
...
parser.add_argument("--model", type=str, default="wo_Exem")  #模型名字
...
# emb_file = args.emb_file or "data/glove.840B.{}d.txt".format(str(emb_dim))
# emb_file = "/home/wangzikun/KEMP_New/data/glove.6B.300d.txt"
emb_file = "/root/autodl-tmp/glove.840B.300d.txt"
