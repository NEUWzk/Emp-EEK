...
def gen_embeddings(n_words, word2index, emb_dim=300, emb_file='/home/wangzikun/Kemp/data/glove.6B.300d.txt'):
    """
...
def get_concept_dict():
    ...
    with open('/home/wangzikun/Kemp/data/cache_dialogue_2dim/train_tokens.p', 'rb') as f1:
        data_tra = pickle.load(f1)

    with open('/home/wangzikun/Kemp/data/cache_dialogue_2dim/valid_tokens.p', 'rb') as f2:
        data_val = pickle.load(f2)

    with open('/home/wangzikun/Kemp/data/cache_dialogue_2dim/test_tokens.p', 'rb') as f3:
    ...
    CN = csv.reader(open("/home/wangzikun/Kemp/data/assertions.csv", "r", encoding="utf-8"))  # ConceptNet raw file

    concept_dict = {}
    concept_file = open("ConceptNet1.json", "w", encoding="utf-8")

    relation_dict = {}
    rd = open("/home/wangzikun/concept-result/relation1.json", "w", encoding="utf-8")
...
def rank_concept_dict(): #对于每一个word,把和他相关的概念进行排序
    ...
    rank_concept_file = open('/home/wangzikun/EmpEEK-GNN/knowledge/ConceptNet_VAD_dict1.json', 'w', encoding='utf-8')  #排名后的ConceptNet字典
...
def read_our_dataset(concept_num=3, total_concept_num=10):
    with open('/home/wangzikun/Emp-EEK-预训练版本/data/knowledge/train.p', 'rb') as f1:
        data_tra = pickle.load(f1)
    with open('/home/wangzikun/Emp-EEK-预训练版本/data/knowledge/valid.p', 'rb') as f2:
        data_val = pickle.load(f2)
    with open('/home/wangzikun/Emp-EEK-预训练版本/data/knowledge/test.p', 'rb') as f3:
        data_tst = pickle.load(f3)
    with open('./vocab_preproc.p', 'rb') as f4:
        vocab = pickle.load(f4)
    ...
    concept = json.load(open("ConceptNet_VAD_dict1.json", "r", encoding="utf-8"))  #保存了全部相关概念
    #在原数据的基础上添加新的字典项
...
if __name__ == '__main__':  #这个py文件用于对经过预处理的ED数据集检索相关概念，添加VAD得分等
    # step 1
     #只有4个字段的字典 # vocab = [word2index, word2count, index2word, n_words]
    ...
    with open('/home/wangzikun/Emp-EEK-预训练版本/data/knowledge/train_new.p', "wb") as f:
        pickle.dump(data_tra, f)
        print("Saved train.p")
    with open('/home/wangzikun/Emp-EEK-预训练版本/data/knowledge/valid_new.p', "wb") as f1:
        pickle.dump(data_val, f1)
        print("Saved valid.p")
    with open('/home/wangzikun/Emp-EEK-预训练版本/data/knowledge/test_new.p', "wb") as f2:
